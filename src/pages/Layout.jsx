...
export default function Layout({ children, currentPageName }) {
  ...
  '/servicos/pedreiro-trancoso': 'Pedreiro em Trancoso | Obras, Reformas e Construção Local',
  '/servicos/cabeleireiro-trancoso': 'Cabeleireiro em Trancoso | Salões e Profissionais de Beleza Locais',
  '/servicos/jardineiro-trancoso': 'Jardineiro em Trancoso | Manutenção de Jardins e Áreas Externas',
  '/servicos/pintor-trancoso': 'Pintor em Trancoso | Pintura Residencial e Comercial com Profissionais Locais',
  '/servicos/encanador-trancoso': 'Encanador em Trancoso | Reparos Hidráulicos com Prestadores Locais',
};
  ...
  '/Home': 'Encontre os melhores prestadores de serviço em Trancoso. Conectamos você a profissionais de limpeza, construção, beleza e muito mais.',
  '/ServicosCategoria': 'Navegue por categorias e encontre o profissional ideal para suas necessidades em Trancoso.',
  '/PrestadorPerfil': 'Veja o perfil detalhado do prestador de serviço, avaliações e serviços oferecidos em Trancoso.',
  '/ServicoDetalhes': 'Conheça os detalhes de cada serviço e contrate com confiança em Trancoso.',
  '/Planos': 'Conheça nossos planos para prestadores de serviço e escolha o melhor para seu negócio em Trancoso.',
  ...
  '/servicos/pedreiro-trancoso': 'Encontre pedreiro em Trancoso para obras, reformas e construção em casas, pousadas e imóveis de temporada. Prestadores locais verificados. Peça orçamento agora.',
  '/servicos/cabeleireiro-trancoso': 'Encontre cabeleireiro em Trancoso para corte, coloração e tratamentos capilares. Profissionais locais verificados para moradores e turistas. Agende já.',
  '/servicos/jardineiro-trancoso': 'Encontre jardineiro em Trancoso para manutenção de jardins, gramados e áreas externas em casas e pousadas. Prestadores locais de confiança. Peça orçamento rápido.',
  '/servicos/pintor-trancoso': 'Encontre pintor em Trancoso para pintura residencial, comercial e imóveis de temporada. Prestadores locais verificados, atendimento ágil. Solicite orçamento agora.',
  '/servicos/encanador-trancoso': 'Encontre encanador em Trancoso para reparos hidráulicos, vazamentos e instalações em casas, pousadas e imóveis. Prestadores locais verificados. Peça orçamento agora.',
};
